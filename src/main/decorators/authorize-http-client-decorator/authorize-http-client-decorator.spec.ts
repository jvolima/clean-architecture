...
describe('AuthorizeHttpClientDecorator', () => {
  ...
  it('Should be able to add headers to HttpClient', async () => {
  ...
  it('Should be able to merge headers to HttpClient', async () => {
    const { sut, getStorageSpy, httpClientSpy } = makeSut()
    getStorageSpy.value = mockAccountModel()
  ...
  it('Should be able to return the same result as HttpClient', async () => {
    const { sut, httpClientSpy } = makeSut()
