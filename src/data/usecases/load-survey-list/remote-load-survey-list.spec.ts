...
describe('RemoteLoadSurveyList', () => {
  ...
  it('Should be able to return a list of LoadSurveyList.Model if HttpClient returns 200', async () => {
    const { sut, httpClientSpy } = makeSut()
  ...
  it('Should be able to return an empty list if HttpClient returns 204', async () => {
    const { sut, httpClientSpy } = makeSut()
    httpClientSpy.response = {
