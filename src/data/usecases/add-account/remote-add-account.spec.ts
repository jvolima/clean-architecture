...
describe('RemoteAddAccount', () => {
  ...
  it('Should be able to throw EmailInUseError if HttpPostClient returns 403', async () => {
    const { sut, httpPostClientSpy } = makeSut()
  ...
  it('Should be able to return an AddAccount.Model if HttpPostClient returns 200', async () => {
    const { sut, httpPostClientSpy } = makeSut()
