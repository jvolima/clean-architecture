...
describe('RemoteAddAccount', () => {
  ...
  it('Should be able to call HttpClient with correct body', async () => {
  ...
  it('Should be able to throw EmailInUseError if HttpClient returns 403', async () => {
    const { sut, httpClientSpy } = makeSut()
  ...
  it('Should be able to return an AddAccount.Model if HttpClient returns 200', async () => {
    const { sut, httpClientSpy } = makeSut()
